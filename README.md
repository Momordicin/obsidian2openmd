...
Auto detection and removal of certain personal informations, it may require an one-step set-up when you use it first time.  
  
本程序针对Fuwari网页生成markdown文件, 可以自动生成前缀style.  
This software helps generate style context and posts for Fuwari-styled website. 
# Reminder
